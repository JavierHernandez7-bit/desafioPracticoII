...

        {
            ...
            for (i = 1; i <= 2; ++i)
            {
                ...
                do
                {
                    ...
                    {
                        Console.WriteLine("No podemos trabajar con empleados mayores a 20 ingrese nuevamente");
                    }



                } while (numeroEmpleados  < 10 || numeroEmpleados > 20);
...
//Javier Enrique Hérnandez Márquez HM210444